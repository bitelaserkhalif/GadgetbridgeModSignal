...
package blk.freeyourgadget.gadgetbridge;
...
import blk.freeyourgadget.gadgetbridge.database.DBOpenHelper;
import blk.freeyourgadget.gadgetbridge.database.PeriodicExporter;
import blk.freeyourgadget.gadgetbridge.devices.DeviceManager;
import blk.freeyourgadget.gadgetbridge.entities.DaoMaster;
import blk.freeyourgadget.gadgetbridge.entities.DaoSession;
import blk.freeyourgadget.gadgetbridge.entities.Device;
import blk.freeyourgadget.gadgetbridge.externalevents.BluetoothStateChangeReceiver;
import blk.freeyourgadget.gadgetbridge.externalevents.opentracks.OpenTracksContentObserver;
...
import static blk.freeyourgadget.gadgetbridge.model.DeviceType.AMAZFITBIP;
import static blk.freeyourgadget.gadgetbridge.model.DeviceType.AMAZFITCOR;
import static blk.freeyourgadget.gadgetbridge.model.DeviceType.AMAZFITCOR2;
import static blk.freeyourgadget.gadgetbridge.model.DeviceType.FITPRO;
import static blk.freeyourgadget.gadgetbridge.model.DeviceType.GALAXY_BUDS;
import static blk.freeyourgadget.gadgetbridge.model.DeviceType.LEFUN;
import static blk.freeyourgadget.gadgetbridge.model.DeviceType.MIBAND;
import static blk.freeyourgadget.gadgetbridge.model.DeviceType.MIBAND2;
import static blk.freeyourgadget.gadgetbridge.model.DeviceType.MIBAND3;
import static blk.freeyourgadget.gadgetbridge.model.DeviceType.PEBBLE;
import static blk.freeyourgadget.gadgetbridge.model.DeviceType.TLW64;
import static blk.freeyourgadget.gadgetbridge.model.DeviceType.WATCHXPLUS;
import static blk.freeyourgadget.gadgetbridge.model.DeviceType.fromKey;
...
public class GBApplication extends Application {
    ...
    public static final String ACTION_QUIT
            = "blk.freeyourgadget.gadgetbridge.gbapplication.action.quit";
    public static final String ACTION_LANGUAGE_CHANGE = "blk.freeyourgadget.gadgetbridge.gbapplication.action.language_change";
    public static final String ACTION_NEW_DATA = "blk.freeyourgadget.gadgetbridge.action.new_data";
    ...
    private void migratePrefs(int oldVersion) {
        ...
        if (oldVersion < 6) {
            ...
            migrateStringPrefToPerDevicePref("mi_button_press_broadcast", "blk.freeyourgadget.gadgetbridge.ButtonPressed", "button_action_broadcast", new ArrayList<>(Collections.singletonList(MIBAND2)));
        }
        if (oldVersion < 7) {
