...
package blk.freeyourgadget.gadgetbridge.service.devices.qhybrid;
...
import blk.freeyourgadget.gadgetbridge.service.devices.qhybrid.adapter.WatchAdapterFactory;
...
public class QHybridSupport extends QHybridBaseSupport {
    ...
    public static final String QHYBRID_COMMAND_UPDATE_SETTINGS = "blk.freeyourgadget.gadgetbridge.Q_UPDATE_SETTINGS";
    public static final String QHYBRID_COMMAND_OVERWRITE_BUTTONS = "blk.freeyourgadget.gadgetbridge.Q_OVERWRITE_BUTTONS";
    public static final String QHYBRID_COMMAND_UPDATE_WIDGETS = "blk.freeyourgadget.gadgetbridge.Q_UPDATE_WIDGETS";
    public static final String QHYBRID_COMMAND_SET_MENU_MESSAGE = "blk.freeyourgadget.gadgetbridge.Q_SET_MENU_MESSAGE";
    public static final String QHYBRID_COMMAND_SEND_MENU_ITEMS = "blk.freeyourgadget.gadgetbridge.Q_SEND_MENU_ITEMS";
    public static final String QHYBRID_COMMAND_SET_WIDGET_CONTENT = "blk.freeyourgadget.gadgetbridge.Q_SET_WIDGET_CONTENT";
    public static final String QHYBRID_COMMAND_SET_BACKGROUND_IMAGE = "blk.freeyourgadget.gadgetbridge.Q_SET_BACKGROUND_IMAGE";
    public static final String QHYBRID_COMMAND_UNINSTALL_APP = "blk.freeyourgadget.gadgetbridge.Q_UNINSTALL_APP";
    public static final String QHYBRID_COMMAND_PUSH_CONFIG = "blk.freeyourgadget.gadgetbridge.Q_PUSH_CONFIG";
    public static final String QHYBRID_COMMAND_SWITCH_WATCHFACE = "blk.freeyourgadget.gadgetbridge.Q_SWITCH_WATCHFACE";

    public static final String QHYBRID_COMMAND_DOWNLOAD_FILE = "blk.freeyourgadget.gadgetbridge.Q_DOWNLOAD_FILE";
    public static final String QHYBRID_COMMAND_UPLOAD_FILE = "blk.freeyourgadget.gadgetbridge.Q_UPLOAD_FILE";

    public static final String QHYBRID_ACTION_DOWNLOADED_FILE = "blk.freeyourgadget.gadgetbridge.Q_DOWNLOADED_FILE";
    public static final String QHYBRID_ACTION_UPLOADED_FILE = "blk.freeyourgadget.gadgetbridge.Q_UPLOADED_FILE";

    private static final String QHYBRID_ACTION_SET_ACTIVITY_HAND = "blk.freeyourgadget.gadgetbridge.Q_SET_ACTIVITY_HAND";

    public static final String QHYBRID_EVENT_SETTINGS_UPDATED = "blk.freeyourgadget.gadgetbridge.Q_SETTINGS_UPDATED";
    public static final String QHYBRID_EVENT_FILE_UPLOADED = "blk.freeyourgadget.gadgetbridge.Q_FILE_UPLOADED";
    public static final String QHYBRID_COMMAND_NOTIFICATION_CONFIG_CHANGED = "blk.freeyourgadget.gadgetbridge.Q_NOTIFICATION_CONFIG_CHANGED";

    public static final String QHYBRID_EVENT_BUTTON_PRESS = "blk.freeyourgadget.gadgetbridge.Q_BUTTON_PRESSED";
    public static final String QHYBRID_EVENT_MULTI_BUTTON_PRESS = "blk.freeyourgadget.gadgetbridge.Q_MULTI_BUTTON_PRESSED";
    public static final String QHYBRID_EVENT_COMMUTE_MENU = "blk.freeyourgadget.gadgetbridge.Q_COMMUTE_MENU";
