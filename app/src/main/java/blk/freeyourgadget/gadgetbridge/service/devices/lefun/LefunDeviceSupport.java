...
package blk.freeyourgadget.gadgetbridge.service.devices.lefun;
...
import blk.freeyourgadget.gadgetbridge.devices.lefun.commands.FeaturesCommand;
import blk.freeyourgadget.gadgetbridge.devices.lefun.commands.FindPhoneCommand;
import blk.freeyourgadget.gadgetbridge.devices.lefun.commands.GetActivityDataCommand;
import blk.freeyourgadget.gadgetbridge.devices.lefun.commands.GetPpgDataCommand;
import blk.freeyourgadget.gadgetbridge.devices.lefun.commands.GetSleepDataCommand;
import blk.freeyourgadget.gadgetbridge.devices.lefun.commands.GetStepsDataCommand;
import blk.freeyourgadget.gadgetbridge.devices.lefun.commands.PpgResultCommand;
import blk.freeyourgadget.gadgetbridge.devices.lefun.commands.SettingsCommand;
import blk.freeyourgadget.gadgetbridge.entities.DaoSession;
import blk.freeyourgadget.gadgetbridge.entities.LefunActivitySample;
import blk.freeyourgadget.gadgetbridge.entities.LefunActivitySampleDao;
import blk.freeyourgadget.gadgetbridge.entities.LefunBiometricSample;
import blk.freeyourgadget.gadgetbridge.entities.LefunSleepSample;
...
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.FindDeviceRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.GetActivityDataRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.GetBatteryLevelRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.GetEnabledFeaturesRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.GetFirmwareInfoRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.GetGeneralSettingsRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.GetHydrationReminderIntervalRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.GetPpgDataRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.GetSedentaryReminderIntervalRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.GetSleepDataRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.Request;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.SendCallNotificationRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.SendNotificationRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.SetAlarmRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.SetEnabledFeaturesRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.SetGeneralSettingsRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.SetHydrationReminderIntervalRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.SetLanguageRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.SetProfileRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.SetSedentaryReminderIntervalRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.SetTimeRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.requests.StartPpgRequest;
...
public class LefunDeviceSupport extends AbstractBTLEDeviceSupport {
    ...
    // Adapted from blk.freeyourgadget.gadgetbridge.service.devices.makibeshr3.MakibesHR3DeviceSupport.broadcastSample
