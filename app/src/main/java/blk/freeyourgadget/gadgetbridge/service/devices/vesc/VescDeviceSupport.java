...
package blk.freeyourgadget.gadgetbridge.service.devices.vesc;
...
public class VescDeviceSupport extends VescBaseDeviceSupport {
    ...
    public static final String COMMAND_SET_RPM = "blk.freeyourgadget.gadgetbridge.vesc.command.SET_RPM";
    public static final String COMMAND_SET_CURRENT = "blk.freeyourgadget.gadgetbridge.vesc.command.SET_CURRENT";
    public static final String COMMAND_SET_BREAK_CURRENT = "blk.freeyourgadget.gadgetbridge.vesc.command.SET_BREAK_CURRENT";
    public static final String COMMAND_GET_VALUES = "blk.freeyourgadget.gadgetbridge.vesc.command.GET_VALUES";
    ...
    public static final String ACTION_GOT_VALUES = "blk.freeyourgadget.gadgetbridge.vesc.action.GOT_VALUES";
