...
import blk.freeyourgadget.gadgetbridge.devices.lefun.commands.NotificationCommand;
...
public class SendNotificationRequest extends AbstractSendNotificationRequest {
    ...
    protected String getMessage() {
        // Based on blk.freeyourgadget.gadgetbridge.service.devices.id115.SendNotificationOperation
        String message = "";
