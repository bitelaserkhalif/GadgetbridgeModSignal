...
package blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitgtr2;
...
public class AmazfitGTR2eFirmwareInfo extends HuamiFirmwareInfo {
    ...
    public AmazfitGTR2eFirmwareInfo(byte[] bytes) {
        super(bytes);
    }
    ...
    public boolean isGenerallyCompatibleWith(GBDevice device) {
        return isHeaderValid() && device.getType() == DeviceType.AMAZFITGTR2E;
    }
