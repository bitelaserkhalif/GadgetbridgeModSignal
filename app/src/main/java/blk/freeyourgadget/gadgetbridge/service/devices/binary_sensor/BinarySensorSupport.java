...
import blk.freeyourgadget.gadgetbridge.service.devices.binary_sensor.protocol.message.GetSensorRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.binary_sensor.protocol.message.Response;
import blk.freeyourgadget.gadgetbridge.service.devices.binary_sensor.protocol.message.SetSensorRequest;
import blk.freeyourgadget.gadgetbridge.service.devices.binary_sensor.protocol.parameter.Parameter;
import blk.freeyourgadget.gadgetbridge.service.devices.binary_sensor.protocol.parameter.SensorState;
...
public class BinarySensorSupport extends BinarySensorBaseSupport {
    ...
    final public static String ACTION_SENSOR_STATE_CHANGED = "blk.freeyourgadget.gadgetbridge.binary_sensor.STATE_CHANGED";
    final public static String ACTION_SENSOR_STATE_REQUEST = "blk.freeyourgadget.gadgetbridge.binary_sensor.STATE_REQUEST";

    private static final Logger logger = LoggerFactory.getLogger(BinarySensorSupport.class);

    private blk.freeyourgadget.gadgetbridge.service.devices.binary_sensor.protocol.constants.SensorState sensorState = null;
    ...
    void sendStateChangeIntent(boolean sendGlobally){
        ...
        intent.putExtra("EXTRA_SENSOR_CLOSED", sensorState == blk.freeyourgadget.gadgetbridge.service.devices.binary_sensor.protocol.constants.SensorState.SENSOR_STATE_CLOSED);
