...
package blk.freeyourgadget.gadgetbridge.service.devices.pinetime;

import static blk.freeyourgadget.gadgetbridge.devices.pinetime.weather.WeatherData.mapOpenWeatherConditionToCloudCover;
import static blk.freeyourgadget.gadgetbridge.devices.pinetime.weather.WeatherData.mapOpenWeatherConditionToPineTimeObscuration;
import static blk.freeyourgadget.gadgetbridge.devices.pinetime.weather.WeatherData.mapOpenWeatherConditionToPineTimePrecipitation;
import static blk.freeyourgadget.gadgetbridge.devices.pinetime.weather.WeatherData.mapOpenWeatherConditionToPineTimeSpecial;
...
import blk.freeyourgadget.gadgetbridge.devices.pinetime.PineTimeActivitySampleProvider;
import blk.freeyourgadget.gadgetbridge.devices.pinetime.PineTimeDFUService;
import blk.freeyourgadget.gadgetbridge.devices.pinetime.PineTimeInstallHandler;
import blk.freeyourgadget.gadgetbridge.devices.pinetime.PineTimeJFConstants;
import blk.freeyourgadget.gadgetbridge.devices.pinetime.weather.WeatherData;
...
import blk.freeyourgadget.gadgetbridge.service.btle.profiles.alertnotification.OverflowStrategy;
...
public class PineTimeJFSupport extends AbstractBTLEDeviceSupport implements DfuLogListener {
    ...
    public void onNotification(NotificationSpec notificationSpec) {
        ...
        if (isFirmwareAtLeastVersion0_15()) {
            String senderOrTitle = blk.freeyourgadget.gadgetbridge.util.StringUtils.getFirstOf(notificationSpec.sender, notificationSpec.title);
