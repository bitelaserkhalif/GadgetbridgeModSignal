...
import blk.freeyourgadget.gadgetbridge.service.devices.asteroidos.AsteroidOSDeviceSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.binary_sensor.BinarySensorSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.fitpro.FitProDeviceSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.banglejs.BangleJSDeviceSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.casio.CasioGB6900DeviceSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.casio.CasioGBX100DeviceSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.domyos.DomyosT540Support;
import blk.freeyourgadget.gadgetbridge.service.devices.flipper.zero.support.FlipperZeroSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.galaxy_buds.GalaxyBudsDeviceSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.hplus.HPlusSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitband5.AmazfitBand5Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitband7.AmazfitBand7Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitbip.AmazfitBipLiteSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitbip.AmazfitBipSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitbips.AmazfitBipSLiteSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitbips.AmazfitBipSSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitbipu.AmazfitBipUSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitbipupro.AmazfitBipUProSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitcor.AmazfitCorSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitcor2.AmazfitCor2Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitgtr.AmazfitGTRLiteSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitgtr.AmazfitGTRSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitgtr2.AmazfitGTR2Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitgtr2.AmazfitGTR2eSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitgtr3.AmazfitGTR3Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitgtr4.AmazfitGTR4Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitgts.AmazfitGTSSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitgts2.AmazfitGTS2MiniSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitgts2.AmazfitGTS2Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitgts2.AmazfitGTS2eSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitgts3.AmazfitGTS3Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitgts4.AmazfitGTS4Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitgts4mini.AmazfitGTS4MiniSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitneo.AmazfitNeoSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitpop.AmazfitPopSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitpoppro.AmazfitPopProSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfittrex.AmazfitTRexSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfittrex2.AmazfitTRex2Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfittrexpro.AmazfitTRexProSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitvergel.AmazfitVergeLSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitx.AmazfitXSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.miband2.MiBand2Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.miband3.MiBand3Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.miband4.MiBand4Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.miband5.MiBand5Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.miband6.MiBand6Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.miband7.MiBand7Support;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.zeppe.ZeppESupport;
import blk.freeyourgadget.gadgetbridge.service.devices.id115.ID115Support;
import blk.freeyourgadget.gadgetbridge.service.devices.itag.ITagSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.jyou.BFH16DeviceSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.jyou.TeclastH30.TeclastH30Support;
import blk.freeyourgadget.gadgetbridge.service.devices.jyou.y5.Y5Support;
import blk.freeyourgadget.gadgetbridge.service.devices.lefun.LefunDeviceSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.lenovo.watchxplus.WatchXPlusDeviceSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.liveview.LiveviewSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.makibeshr3.MakibesHR3DeviceSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.miband.MiBandSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.mijia_lywsd02.MijiaLywsd02Support;
import blk.freeyourgadget.gadgetbridge.service.devices.miscale2.MiScale2DeviceSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.no1f1.No1F1Support;
import blk.freeyourgadget.gadgetbridge.service.devices.nothing.Ear1Support;
import blk.freeyourgadget.gadgetbridge.service.devices.nut.NutSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.pebble.PebbleSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.pinetime.PineTimeJFSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.qc35.QC35BaseSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.qhybrid.QHybridSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.roidmi.RoidmiSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.smaq2oss.SMAQ2OSSSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.soflow.SoFlowSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.sony.headphones.SonyHeadphonesSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.sonyswr12.SonySWR12DeviceSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.supercars.SuperCarsSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.tlw64.TLW64Support;
import blk.freeyourgadget.gadgetbridge.service.devices.um25.Support.UM25Support;
import blk.freeyourgadget.gadgetbridge.service.devices.vesc.VescDeviceSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.vibratissimo.VibratissimoSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.waspos.WaspOSDeviceSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.watch9.Watch9DeviceSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.xwatch.XWatchSupport;
import blk.freeyourgadget.gadgetbridge.service.devices.zetime.ZeTimeDeviceSupport;
