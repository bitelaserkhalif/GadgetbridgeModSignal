...
public class FindPhoneActivity extends AbstractGBActivity {
    ...
    public static final String ACTION_FOUND = "blk.freeyourgadget.gadgetbridge.findphone.action.reply";
    public static final String ACTION_VIBRATE = "blk.freeyourgadget.gadgetbridge.findphone.action.vibrate";
    public static final String ACTION_RING = "blk.freeyourgadget.gadgetbridge.findphone.action.ring";
