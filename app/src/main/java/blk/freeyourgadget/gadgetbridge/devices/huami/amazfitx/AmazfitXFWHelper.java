...
package blk.freeyourgadget.gadgetbridge.devices.huami.amazfitx;
...
import blk.freeyourgadget.gadgetbridge.service.devices.huami.amazfitx.AmazfitXFirmwareInfo;
...
public class AmazfitXFWHelper extends HuamiFWHelper {
    ...
    protected void determineFirmwareInfo(byte[] wholeFirmwareBytes) {
        firmwareInfo = new AmazfitXFirmwareInfo(wholeFirmwareBytes);
