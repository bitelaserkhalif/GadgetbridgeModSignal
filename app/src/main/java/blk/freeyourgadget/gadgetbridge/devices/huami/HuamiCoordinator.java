...
import blk.freeyourgadget.gadgetbridge.devices.miband.MiBandPairingActivity;
...
import blk.freeyourgadget.gadgetbridge.entities.AbstractActivitySample;
import blk.freeyourgadget.gadgetbridge.entities.DaoSession;
import blk.freeyourgadget.gadgetbridge.entities.Device;
import blk.freeyourgadget.gadgetbridge.entities.MiBandActivitySampleDao;
import blk.freeyourgadget.gadgetbridge.impl.GBDevice;
import blk.freeyourgadget.gadgetbridge.model.ActivitySummaryParser;
import blk.freeyourgadget.gadgetbridge.service.devices.huami.HuamiVibrationPatternNotificationType;
...
public abstract class HuamiCoordinator extends AbstractBLEDeviceCoordinator {
    ...
    public int[] getSupportedDeviceSpecificAuthenticationSettings() {
        return new int[]{R.xml.devicesettings_pairingkey_huami};
    }
