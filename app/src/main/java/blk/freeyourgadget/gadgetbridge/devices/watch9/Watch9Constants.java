...
package blk.freeyourgadget.gadgetbridge.devices.watch9;
...
public final class Watch9Constants {
    ...
    public static final String ACTION_CALIBRATION
            = "blk.freeyourgadget.gadgetbridge.devices.action.watch9.start_calibration";
    public static final String ACTION_CALIBRATION_SEND
            = "blk.freeyourgadget.gadgetbridge.devices.action.watch9.send_calibration";
    public static final String ACTION_CALIBRATION_HOLD
            = "blk.freeyourgadget.gadgetbridge.devices.action.watch9.keep_calibrating";
