/*  Copyright (C) 2018-2021 maxirnilian, mkusnierz
...
package blk.freeyourgadget.gadgetbridge.devices.lenovo;
...
public class LenovoWatchConstants {
    ...
    public static final String ACTION_CALIBRATION
            = "blk.freeyourgadget.gadgetbridge.devices.action.lenovowatch.start_calibration";
    public static final String ACTION_CALIBRATION_SEND
            = "blk.freeyourgadget.gadgetbridge.devices.action.lenovowatch.send_calibration";
    public static final String ACTION_CALIBRATION_HOLD
            = "blk.freeyourgadget.gadgetbridge.devices.action.lenovowatch.keep_calibrating";
