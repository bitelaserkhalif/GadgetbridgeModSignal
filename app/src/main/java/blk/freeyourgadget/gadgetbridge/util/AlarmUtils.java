/*  Copyright (C) 2019-2021 Andreas Shimokawa, Carsten Pfeiffer, Daniele
    Gobbetti, Dmitry Markin, Taavi Eomäe
...
public class AlarmUtils {
     ...
     * @return
     */
    public static blk.freeyourgadget.gadgetbridge.model.Alarm createSingleShot(int index, boolean smartWakeup, boolean snooze, Calendar calendar) {
     ...
     * @return
     */
    public static Calendar toCalendar(blk.freeyourgadget.gadgetbridge.model.Alarm alarm) {
