...
import blk.freeyourgadget.gadgetbridge.devices.asteroidos.AsteroidOSDeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitgts4.AmazfitGTS4Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitgts4mini.AmazfitGTS4MiniCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfittrex2.AmazfitTRex2Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.sony.headphones.coordinators.SonyLinkBudsSCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.soflow.SoFlowCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.supercars.SuperCarsCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.fitpro.FitProDeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.UnknownDeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.banglejs.BangleJSCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.casio.gb6900.CasioGB6900DeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.casio.gbx100.CasioGBX100DeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.domyos.DomyosT540Cooridnator;
import blk.freeyourgadget.gadgetbridge.devices.galaxy_buds.GalaxyBuds2DeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.flipper.zero.FlipperZeroCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.galaxy_buds.GalaxyBudsDeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.galaxy_buds.GalaxyBudsLiveDeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.galaxy_buds.GalaxyBudsProDeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.galaxy_buds.GalaxyBuds2ProDeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.hplus.EXRIZUK8Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.hplus.HPlusCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.hplus.MakibesF68Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.hplus.Q8Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.hplus.SG2Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitband5.AmazfitBand5Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitband7.AmazfitBand7Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitbips.AmazfitBipSLiteCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitgts2.AmazfitGTS2MiniCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitgts2.AmazfitGTS2eCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitneo.AmazfitNeoCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitbip.AmazfitBipCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitbip.AmazfitBipLiteCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitbips.AmazfitBipSCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitbipu.AmazfitBipUCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitbipupro.AmazfitBipUProCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitcor.AmazfitCorCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitcor2.AmazfitCor2Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitgtr.AmazfitGTRCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitgtr.AmazfitGTRLiteCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitgtr2.AmazfitGTR2Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitpop.AmazfitPopCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitpoppro.AmazfitPopProCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfittrexpro.AmazfitTRexProCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitx.AmazfitXCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.miband6.MiBand6Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.miband7.MiBand7Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitgts3.AmazfitGTS3Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitgtr3.AmazfitGTR3Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitgtr4.AmazfitGTR4Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.zeppe.ZeppECoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitgtr2.AmazfitGTR2eCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitgts.AmazfitGTSCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitgts2.AmazfitGTS2Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfitvergel.AmazfitVergeLCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.amazfittrex.AmazfitTRexCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.miband2.MiBand2Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.miband2.MiBand2HRXCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.miband3.MiBand3Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.miband4.MiBand4Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.huami.miband5.MiBand5Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.id115.ID115Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.itag.ITagCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.jyou.BFH16DeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.jyou.TeclastH30.TeclastH30Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.jyou.y5.Y5Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.lefun.LefunDeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.lenovo.watchxplus.WatchXPlusDeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.liveview.LiveviewCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.makibeshr3.MakibesHR3Coordinator;
...
import blk.freeyourgadget.gadgetbridge.devices.mijia_lywsd02.MijiaLywsd02Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.miscale2.MiScale2DeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.no1f1.No1F1Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.nothing.Ear1Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.nut.NutCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.pebble.PebbleCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.pinetime.PineTimeJFCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.qc35.QC35Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.qhybrid.QHybridCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.roidmi.Roidmi1Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.roidmi.Roidmi3Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.smaq2oss.SMAQ2OSSCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.sony.headphones.coordinators.SonyWH1000XM2Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.sony.headphones.coordinators.SonyWH1000XM4Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.sonyswr12.SonySWR12DeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.tlw64.TLW64Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.um25.Coordinator.BinarySensorCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.um25.Coordinator.UM25Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.vesc.VescCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.vibratissimo.VibratissimoCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.waspos.WaspOSCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.watch9.Watch9DeviceCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.sony.headphones.coordinators.SonyWFSP800NCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.sony.headphones.coordinators.SonyWH1000XM3Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.sony.headphones.coordinators.SonyWF1000XM3Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.sony.headphones.coordinators.SonyWF1000XM4Coordinator;
import blk.freeyourgadget.gadgetbridge.devices.xwatch.XWatchCoordinator;
import blk.freeyourgadget.gadgetbridge.devices.zetime.ZeTimeCoordinator;
import blk.freeyourgadget.gadgetbridge.entities.Device;
import blk.freeyourgadget.gadgetbridge.entities.DeviceAttributes;
