...
public class IntentApiReceiver extends BroadcastReceiver {
    ...
    public static final String COMMAND_ACTIVITY_SYNC = "blk.freeyourgadget.gadgetbridge.command.ACTIVITY_SYNC";
    public static final String COMMAND_TRIGGER_EXPORT = "blk.freeyourgadget.gadgetbridge.command.TRIGGER_EXPORT";
