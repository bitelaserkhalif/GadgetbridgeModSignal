...
public class PeriodicExporter extends BroadcastReceiver {
    ...
    public static final String ACTION_DATABASE_EXPORT_SUCCESS = "blk.freeyourgadget.gadgetbridge.action.DATABASE_EXPORT_SUCCESS";
    public static final String ACTION_DATABASE_EXPORT_FAIL = "blk.freeyourgadget.gadgetbridge.action.DATABASE_EXPORT_FAIL";
