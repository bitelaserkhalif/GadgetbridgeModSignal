 ...
 */
package blk.freeyourgadget.gadgetbridge.daogen;
...
public class GBDaoGenerator {
    ...
    private static final String MAIN_PACKAGE = "blk.freeyourgadget.gadgetbridge";
    ...
    private static void addAlarms(Schema schema, Entity user, Entity device) {
        ...
        alarm.implementsInterface("blk.freeyourgadget.gadgetbridge.model.Alarm");
    ...
    private static void addReminders(Schema schema, Entity user, Entity device) {
        ...
        reminder.implementsInterface("blk.freeyourgadget.gadgetbridge.model.Reminder");
    ...
    private static void addWorldClocks(Schema schema, Entity user, Entity device) {
        ...
        worldClock.implementsInterface("blk.freeyourgadget.gadgetbridge.model.WorldClock");
